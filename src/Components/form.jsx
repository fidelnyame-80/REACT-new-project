...
const Form = () => {
  ...
  const addNewUser = userUsersStore((state) => state.addNewUser)
...
const handleSubmit = (event) => {
  event.preventDefault()
    ...
    return (
     <div className="min-h-screen bg-linear-to-br from-white via-slate-50 to-slate-200 flex items-center justify-center p-6">
